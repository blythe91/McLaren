...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post charges_url, params: { charge: { description: @charge.description, structure_level_id: @charge.structure_level_id } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { description: @charge.description, structure_level_id: @charge.structure_level_id } }
