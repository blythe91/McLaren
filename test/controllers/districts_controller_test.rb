...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { description: @district.description, region_id: @district.region_id } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { description: @district.description, region_id: @district.region_id } }
