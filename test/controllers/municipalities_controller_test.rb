...
class MunicipalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipality" do
    assert_difference('Municipality.count') do
      post municipalities_url, params: { municipality: { State_id: @municipality.State_id, description: @municipality.description } }
    end
  ...
  test "should update municipality" do
    patch municipality_url(@municipality), params: { municipality: { State_id: @municipality.State_id, description: @municipality.description } }
