...
class SprPeopleControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spr_person" do
    assert_difference('SprPerson.count') do
      post spr_people_url, params: { spr_person: { academic_level_id: @spr_person.academic_level_id, address: @spr_person.address, asv_member: @spr_person.asv_member, document: @spr_person.document, document_type_id: @spr_person.document_type_id, first_last_name: @spr_person.first_last_name, first_name: @spr_person.first_name, gender: @spr_person.gender, main_email: @spr_person.main_email, mobile_phone: @spr_person.mobile_phone, nationality_id: @spr_person.nationality_id, ocupation_id: @spr_person.ocupation_id, phone: @spr_person.phone, relationship_id: @spr_person.relationship_id, representative: @spr_person.representative, second_email: @spr_person.second_email, second_last_name: @spr_person.second_last_name, second_name: @spr_person.second_name } }
    end
  ...
  test "should update spr_person" do
    patch spr_person_url(@spr_person), params: { spr_person: { academic_level_id: @spr_person.academic_level_id, address: @spr_person.address, asv_member: @spr_person.asv_member, document: @spr_person.document, document_type_id: @spr_person.document_type_id, first_last_name: @spr_person.first_last_name, first_name: @spr_person.first_name, gender: @spr_person.gender, main_email: @spr_person.main_email, mobile_phone: @spr_person.mobile_phone, nationality_id: @spr_person.nationality_id, ocupation_id: @spr_person.ocupation_id, phone: @spr_person.phone, relationship_id: @spr_person.relationship_id, representative: @spr_person.representative, second_email: @spr_person.second_email, second_last_name: @spr_person.second_last_name, second_name: @spr_person.second_name } }
