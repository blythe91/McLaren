...
class ParishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parish" do
    assert_difference('Parish.count') do
      post parishes_url, params: { parish: { Municipality_id: @parish.Municipality_id, description: @parish.description } }
    end
  ...
  test "should update parish" do
    patch parish_url(@parish), params: { parish: { Municipality_id: @parish.Municipality_id, description: @parish.description } }
