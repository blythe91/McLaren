...
class AcademicLevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create academic_level" do
    assert_difference('AcademicLevel.count') do
      post academic_levels_url, params: { academic_level: { description: @academic_level.description } }
    end
  ...
  test "should update academic_level" do
    patch academic_level_url(@academic_level), params: { academic_level: { description: @academic_level.description } }
