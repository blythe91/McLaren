...
class AdultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adult" do
    assert_difference('Adult.count') do
      post adults_url, params: { adult: { is_tutor: @adult.is_tutor, person_id: @adult.person_id } }
    end
  ...
  test "should update adult" do
    patch adult_url(@adult), params: { adult: { is_tutor: @adult.is_tutor, person_id: @adult.person_id } }
