...
class RegistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post registries_url, params: { registry: { adult_id: @registry.adult_id, registry_date: @registry.registry_date } }
    end
  ...
  test "should update registry" do
    patch registry_url(@registry), params: { registry: { adult_id: @registry.adult_id, registry_date: @registry.registry_date } }
